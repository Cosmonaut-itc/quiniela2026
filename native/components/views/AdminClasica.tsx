// Vista mínima read-only del panel admin clásico (espejo de
// src/routes/Admin.tsx). SEN-25 la reemplaza por el port completo.
...
export function AdminClasica({ adminToken }: Props) {
    ...
    <Pantalla>
      ...
      <GrainCard className="mt-5 rounded-2xl border border-border bg-card px-4 py-3">
        ...
        <Text className="mt-2 font-sans text-sm text-foreground">
          ...
          {quiniela.filledCount}/{quiniela.numParticipants} lugares ·{" "}
          {statusLabel}
        </Text>
      </GrainCard>
    </Pantalla>
