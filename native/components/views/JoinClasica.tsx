// Vista mínima de Join clásica (espejo de src/routes/Join.tsx): datos reales
// en crudo + flujo de inscripción end-to-end (sin foto, llega con SEN-25).
// SEN-25 la reemplaza por el port completo.
...
export function JoinClasica({ quinielaId, joinToken }: Props) {
  ...
  return (
    <Pantalla>
      ...
      {/* Sección CTA — espejo del bloque !alreadyJoined de Join.tsx; mientras
          el Keychain no resuelve (meToken undefined) no se renderiza nada. */}
      {meToken !== undefined &&
        (meToken ? (
